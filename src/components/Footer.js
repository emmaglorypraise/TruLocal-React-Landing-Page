...
export default function Footer() {
  return (
    <>
      <div className="bg-[#E98100] py-[100px] ">
        <div className="max-w-[986px] mx-auto">
        <div className="py-[30px] flex flex-col text-center justify-center place-content-center pt-[20px] lg:pt-[2px]">
          <div className="mx-auto w-[252px] py-5">
          <img src={logo} alt="logo" className="w-full  " />
          </div>
          <p className="font-Bai-Jamjuree font-semibold text-[32px] leading-[44px] tracking-[-0.02em] text-white py-[20px]">We connect people looking to get their to-do list done with people looking to make extra cash.</p>
